      ...
      <div className={`${contentMaxWidth} mx-auto text-center relative z-10`}>
        ...
        >
          ...
          <p className="text-lg md:text-xl text-gray-300 mb-10 max-w-2xl mx-auto leading-relaxed">
            Establish your unique digital identity in the Web3 space. A <code className="text-primary font-semibold p-1 rounded bg-primary/10">.creator</code> domain is your passport to exclusive courses, earning opportunities, and a verifiable presence in the decentralized creator economy.
          </p>
