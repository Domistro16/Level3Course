      ...
      <div className="max-w-7xl mx-auto">
            ...
            return (
              ...
              >
                ...
                <div className="p-6 flex flex-col flex-grow">
                  ...
                  <p className="text-sm text-gray-400 mb-5 h-12 line-clamp-2 flex-grow">{course.description.split(" Access with .creator domain.")[0]}</p>
        ...
        {isHomePage && (
          <motion.div 
            ...
            <Link to="/courses">
              <Button size="lg" variant="outline" className="border-primary/70 text-primary hover:bg-primary/10 hover:border-primary text-md px-8 py-4 rounded-lg transition-all duration-300 transform hover:scale-105 group">
                Explore All Courses <ArrowRight className="w-5 h-5 ml-2.5 group-hover:translate-x-1 transition-transform" />
              </Button>
            </Link>
          </motion.div>
        )}
